  ...
  window.BookManage = {
    ...
    renderDiscount: function(discount, prepend) {
      ...
      html.find(".editDiscount").click((function(_this) {
        return function() {
          var date, day, e, field, form, month, year, _i, _len, _ref, _ref1;
...
(function() {
  window.Book = {
    ...
    getChapter: function(slug, offset) {
      ...
      s3url = "" + this.base_url + "/html/" + this.chapter.slug + "_fragment.html";
      $(".bookScreenItem").hide();
      $(".bookScreenItem[data-chapter-number=" + this.chapter.number + "]").show();
      this.loadingOn();
      return $.get(s3url, (function(_this) {
        return function(result) {
          ...
          $('#bookHtml').html(bookEl);
          $('#book [data-tralics-id], .footnotes [id], .chapter-star[id]').each(function() {
          ...
          updateScroll = function() {
            if (offset) {
              log("getChapter, scrollTo: " + offset);
    ...
    storeScrollOffset: function() {
      log("storeScrollOffset: " + this.currentScrollTop);
...
(function() {
  window.Purchase = {
    ...
    getCurrentBookOption: function() {
      return this.optionPrice = parseInt($('.bundleItem.active').find('.j_optionPrice').data('price'));
    },
    calculatePrice: function() {
      var sub;
      this.subTotal = this.optionPrice * this.quantity;
      this.discountAmount = this.discount ? (sub = this.discount.amount ? this.discount.amount / 100 : 0, this.discount.percent ? sub += this.discount.percent / 100 * this.subTotal : void 0, sub > this.subTotal ? this.subTotal : sub) : 0;
